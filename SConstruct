...
env.Append(CPPPATH=[
    ...
    'Pods/FirebaseMessaging/FirebaseMessaging/Sources/Public',
    'Pods/FirebaseMessaging/Interop/Analytics/Public',
...
sources = Glob('godot-ios-firebase-message/*.cpp')
sources.append(Glob('godot-ios-firebase-message/*.mm'))
sources.append(Glob('godot-ios-firebase-message/*.m'))
